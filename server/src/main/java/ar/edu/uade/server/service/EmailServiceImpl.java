...
public class EmailServiceImpl {
    ...
    public Boolean sendMailDTO(FormularioDTO formularioDTO, Adopcion adopcion){
        ...
        String msg = "<h1 style='color: red'> Hola! </h1> "+adopcion.getAnimal().getNombre()+" ha recibido una solicitud de adopcion por parte de "+formularioDTO.getNombre()+". \nContacto: "+formularioDTO.getTelefono();
    ...
    public Boolean sendMailDTO(FormularioDTO formularioDTO, Transito transito){
        ...
        String msg = transito.getAnimal().getNombre()+" ha recibido una solicitud de transito por parte de "+formularioDTO.getNombre()+". \nContacto: "+formularioDTO.getTelefono();
    ...
    public Boolean sendMailDTO(FormularioDTO formularioDTO, PublicacionVoluntariado voluntariado){
        ...
        String msg = " Ha recibido una solicitud de voluntariado por parte de "+formularioDTO.getNombre()+". \nContacto: "+formularioDTO.getTelefono();
